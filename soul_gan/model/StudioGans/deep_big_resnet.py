...
class Discriminator(nn.Module):
    def __init__(
        ...
        self.input_conv = MODULES.d_conv2d(
        ...
        if self.d_cond_mtd == "AC":
            ...
            self.embedding = MODULES.d_embedding(
                num_classes, self.out_dims[-1]
            )
